'use client';
// Tweaks panel — density / surface / brand intensity
// Combines the host-protocol shell (TweaksPanel + form controls) with the
// Command Center wiring that drives data-cc-* attributes on <body>.
