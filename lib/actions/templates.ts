...
// ── Event Templates ────────────────────────────────────────────────────────
// Template data lives in lib/event-templates.ts (client-safe, no 'use server').
// Re-export types for server-action consumers.

import { EVENT_TEMPLATES, EVENT_TEMPLATE_LIST, type EventTemplateId } from '@/lib/event-templates';
export type { EventTemplateId } from '@/lib/event-templates';
export { EVENT_TEMPLATE_LIST };
