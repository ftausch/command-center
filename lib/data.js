...
export const D = {
  brands: {
    unicornbakery: {
      id: 'unicornbakery',
      name: 'UnicornBakery',
      sub: 'Podcast · Events · B2B Startup Media',
      initials: 'UB',
      color: '#1a3d5c',
      tagline: 'Der Podcast für Founder, CEOs & das Startup-Ökosystem.',
      capabilities: { podcast: true, events: true },
    },
    selbstfrei: {
      id: 'selbstfrei',
      name: 'SelbstFrei',
      ...
      capabilities: { podcast: true, events: false },
    },
  },
  ...
  templates: {
    ...
    podcast_season: {
      name: 'Podcast Saison-Planung',
      desc: '10-Episoden-Saison von der Konzeption bis zum Finale. Gäste, Produktion, Distribution.',
      avgDuration: '90 Tage',
      tasks: [
        { phase: 'Konzept',      title: 'Saison-Thema & roten Faden definieren',   owner: 'Manager',     daysFromStart: 0 },
        { phase: 'Konzept',      title: 'Gastliste für 10 Episoden erstellen',      owner: 'Manager',     daysFromStart: 3 },
        { phase: 'Konzept',      title: 'Aufnahmetermine für Saison blockieren',    owner: 'Manager',     daysFromStart: 5 },
        { phase: 'Konzept',      title: 'Saisontrailer-Konzept entwickeln',         owner: 'Manager',     daysFromStart: 7 },
        { phase: 'Produktion',   title: 'Intro/Outro für Saison produzieren',       owner: 'Produktion',  daysFromStart: 14 },
        { phase: 'Produktion',   title: 'Cover Art für Saison erstellen',           owner: 'Designer',    daysFromStart: 14 },
        { phase: 'Produktion',   title: 'Alle Episoden aufnehmen',                  owner: 'Produktion',  daysFromStart: 30 },
        { phase: 'Produktion',   title: 'Alle Episoden schneiden & produzieren',    owner: 'Cutter',      daysFromStart: 60 },
        { phase: 'Distribution', title: 'Episoden planen & hochladen',              owner: 'Manager',     daysFromStart: 75 },
        { phase: 'Distribution', title: 'Newsletter-Saison-Ankündigung',            owner: 'Manager',     daysFromStart: 78 },
        { phase: 'Distribution', title: 'Social-Media-Content-Kalender befüllen',   owner: 'Social Media',daysFromStart: 80 },
        { phase: 'Distribution', title: 'Saison live schalten',                     owner: 'Manager',     daysFromStart: 84 },
        { phase: 'Recap',        title: 'Saison-Zahlen auswerten',                  owner: 'Manager',     daysFromStart: 90 },
      ],
    },
    newsletter_campaign: {
      name: 'Newsletter Ausgabe',
      desc: 'Von der Themenidee bis zum Versand. Konzept, Schreiben, Review, Scheduling.',
      avgDuration: '10 Tage',
      tasks: [
        { phase: 'Konzept',  title: 'Thema & Headline definieren',         owner: 'Manager',     daysFromStart: 0 },
        { phase: 'Konzept',  title: 'Inhalt & Struktur planen',            owner: 'Manager',     daysFromStart: 1 },
        { phase: 'Schreiben',title: 'Intro schreiben',                     owner: 'Manager',     daysFromStart: 2 },
        { phase: 'Schreiben',title: 'Haupt-Content schreiben',             owner: 'Manager',     daysFromStart: 3 },
        { phase: 'Schreiben',title: 'CTA & Links einfügen',                owner: 'Manager',     daysFromStart: 4 },
        { phase: 'Review',   title: 'Lektorat & Korrekturen',              owner: 'Manager',     daysFromStart: 6 },
        { phase: 'Review',   title: 'Test-Mail versenden & prüfen',        owner: 'Produktion',  daysFromStart: 7 },
        { phase: 'Versand',  title: 'Newsletter schedulen',                owner: 'Manager',     daysFromStart: 8 },
        { phase: 'Versand',  title: 'Social-Media-Teaser posten',          owner: 'Social Media',daysFromStart: 9 },
        { phase: 'Analyse',  title: 'Open Rate & Klickrate auswerten',     owner: 'Manager',     daysFromStart: 10 },
      ],
    },
    social_batch: {
      name: 'Social Media Content-Batch',
      desc: 'Einen ganzen Monat Content in einer Woche produzieren. Für LinkedIn, Instagram & TikTok.',
      avgDuration: '7 Tage',
      tasks: [
        { phase: 'Planung',      title: 'Content-Kalender für Monat planen',        owner: 'Social Media',daysFromStart: 0 },
        { phase: 'Planung',      title: 'Themen & Hooks für 20 Posts definieren',   owner: 'Manager',     daysFromStart: 0 },
        { phase: 'Produktion',   title: 'Texte für LinkedIn schreiben (10×)',       owner: 'Manager',     daysFromStart: 1 },
        { phase: 'Produktion',   title: 'Captions für Instagram schreiben (10×)',   owner: 'Social Media',daysFromStart: 1 },
        { phase: 'Produktion',   title: 'Grafiken & Visuals erstellen',             owner: 'Designer',    daysFromStart: 2 },
        { phase: 'Produktion',   title: 'Kurzvideos schneiden (5×)',                owner: 'Cutter',      daysFromStart: 3 },
        { phase: 'Review',       title: 'Alle Posts reviewen & freigeben',          owner: 'Manager',     daysFromStart: 5 },
        { phase: 'Scheduling',   title: 'Posts in Tool schedulen',                  owner: 'Social Media',daysFromStart: 6 },
        { phase: 'Scheduling',   title: 'Performance-Tracking einrichten',          owner: 'Social Media',daysFromStart: 7 },
      ],
    },
    selbstfrei: {
